...
class zcuBQ8(Overlay):
    def __init__(self, bitfile_name='zcu111_bq8.bit', **kwargs):
        ...
        # WISHBONE local bus
        # use dev.wbw(addr, value)
        # and dev.wbr(addr)
        # to read/write
        self.sdv = SerialCOBSDevice('/dev/ttyPS1',
                                    1000000)
        self.wbw = self.sdv.write
        self.wbr = self.sdv.read
